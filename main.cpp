//header file
#include <stdio.h>
// #include <conio.h> // Windows only, not needed on Linux
#include <stdlib.h>

//pendeklarasian struct untuk tree awal
struct Node{
	int data;
	Node *kiri;
	Node *kanan;
...
void tambah(Node **root, int databaru)
{
	...
	if((*root) == NULL)
	{
		//pembuatan node baru
		Node *baru;
		//mengalokasikan memori dari node yang telah dibuat
		baru = new Node;
		//menginisialisasi nilai node yang baru dibuat
		baru->data = databaru;
		baru->kiri = NULL;
		baru->kanan = NULL;
		(*root) = baru;
	...
	//jika akan untuk data yang akan dimasukkan memiliki nilai yang sama dengan data pada
	//root
	else if(databaru == (*root)->data)
